        ...
        <div class="newslatter-wrapper">
            ...
            <div class="row row-gap-4">
                <div class="col-lg-6">
                    ...
                    <p class="fw-bold text-white">Together, let us create a skilled, empowered, and sustainable India.
                    </p>
                </div>
                <div class="col-lg-6">
                    <div class="news-form mt-1">
                        ...
                        <!-- Contact form -->
                        <form class="row g-3" method="POST" action="{{ route('your.route.name') }}">
                            @csrf
                    ...
                    <div class="">
                        ...
                        <div class="d-flex align-items-center gap-8">
                            <a href="mailto:{{ $defaultSettings->contact_email }}"
                                class="h6 fw-400 black  hover-content"><i class="fa fa-envelope text-primary"></i>
                                {{ $defaultSettings->contact_email ?? null }}</a>
                        </div>
                        <div class="d-flex align-items-center gap-8 mt-2">
                            <a href="#" class="h6 fw-400 black  hover-content"><i
                                    class="fa fa-map-location text-primary"></i>
                                {{ $defaultSettings->contact_address ?? null }}</a>
                        </div>
                        <!-- Social Media Icons -->
                        <div class="d-flex align-items-center gap-3 ms-3 mt-3">
                            <a href="{{ $defaultSettings->facebook ?? null }}" target="_blank"
                                class="text-primary fs-5" aria-label="Facebook">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="{{ $defaultSettings->twitter ?? null }}" target="_blank"
                                class="text-primary fs-5" aria-label="Twitter">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a href="{{ $defaultSettings->instagram ?? null }}" target="_blank"
                                class="text-primary fs-5" aria-label="Instagram">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="{{ $defaultSettings->linkedin ?? null }}" target="_blank"
                                class="text-primary fs-5" aria-label="LinkedIn">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a href="{{ $defaultSettings->youtube ?? null }}" target="_blank"
                                class="text-primary fs-5" aria-label="LinkedIn">
