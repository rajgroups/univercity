            ...
            <section class="blog-detail-sec mb-120">
                <div class="container-fluid">
                    <div class="row row-gap-4">
                        <div class="col-lg-8">
                            <img src="assets/media/blogs/blog-detail-img-1.jpg" class="br-24 w-100 mb-4" alt="">

                            <h5 class="fw-bold mb-4">ISICO School Programs</h5>
                            <p class="mb-4">
                                The Indian Skill Institute Cooperation (ISICO) has designed a forward-thinking and
                                inclusive school program to empower students, particularly in rural and underserved
                                communities, with the knowledge, skills, and awareness necessary for a sustainable and
                                prosperous future.
                            </p>

                            <!-- Section 1 -->
                            <h6 class="fw-bold mb-3">1. Holistic School Education (Primary to Secondary Education)</h6>
                            <ul class="mb-4">
                                <li><strong>Curriculum Integration:</strong> Blending vocational skills and practical
                                    knowledge with traditional academics.</li>
                                <li><strong>Mental and Cognitive Health:</strong> Promoting emotional intelligence,
                                    mindfulness, and problem-solving through activities.</li>
                                <li><strong>Green Jobs Awareness:</strong> Introducing students to sustainable practices
                                    and emerging green job opportunities.</li>
                            </ul>

                            <!-- Section 2 -->
                            <h6 class="fw-bold mb-3">2. Digital Learning Program</h6>
                            <ul class="mb-4">
                                <li><strong>Digital Literacy:</strong> Training students in essential digital skills.
                                </li>
                                <li><strong>Interactive Platforms:</strong> Engaging learners through gamified and
                                    interactive educational content.</li>
                                <li><strong>Global Virtual Webinars:</strong> Bringing expert insights and global
                                    perspectives to rural classrooms.</li>
                            </ul>

                            <!-- Section 3 -->
                            <h6 class="fw-bold mb-3">3. Specialized Skills for School Students</h6>
                            <ul class="mb-4">
                                <li><strong>STEM Focus:</strong> Hands-on projects in Science, Technology, Engineering,
                                    and Mathematics.</li>
                                <li><strong>Entrepreneurship Training:</strong> Fostering entrepreneurial thinking from
                                    an early age.</li>
                                <li><strong>Workplace Essentials:</strong> Building communication, teamwork, and
                                    leadership skills.</li>
                            </ul>

                            <!-- Section 4 -->
                            <h6 class="fw-bold mb-3">4. Natural Talent Identification (NTI)</h6>
                            <ul class="mb-4">
                                <li><strong>Competitions and Exhibitions:</strong> Encouraging creativity and
                                    innovation.</li>
                                <li><strong>Eco-Friendly Innovation:</strong> Promoting ideas in sustainability and
                                    green technologies.</li>
                                <li><strong>Opportunities for Growth:</strong> Providing platforms for recognition and
                                    career paths.</li>
                            </ul>

                            <!-- Section 5 -->
                            <h6 class="fw-bold mb-3">5. Inclusive Learning for Special Needs</h6>
                            <ul class="mb-4">
                                <li><strong>Personalized Teaching:</strong> Adaptive and accessible methods for
                                    individual learners.</li>
                                <li><strong>Assistive Technologies:</strong> Tools for children with special needs.</li>
                                <li><strong>Empowerment:</strong> Building confidence and independence in students.</li>
                            </ul>

                            <!-- Section 6 -->
                            <h6 class="fw-bold mb-3">6. Teacher Training & Development</h6>
                            <ul class="mb-4">
                                <li><strong>Modern Pedagogy:</strong> Student-centered methodologies.</li>
                                <li><strong>Skill-Based Training:</strong> Integrating vocational education.</li>
                                <li><strong>Ongoing Support:</strong> Continuous development and peer-learning programs.
                                </li>
                            </ul>

                            <!-- Section 7 -->
                            <h6 class="fw-bold mb-3">7. Community & Parental Involvement</h6>
                            <ul class="mb-4">
                                <li><strong>Parental Workshops:</strong> Involving parents in skill education journeys.
                                </li>
                                <li><strong>Local Partnerships:</strong> Aligning with community needs for impact.</li>
                            </ul>

                            <!-- Section 8 -->
                            <h6 class="fw-bold mb-3">8. Future Green Careers Program</h6>
                            <ul class="mb-4">
                                <li><strong>Awareness Campaigns:</strong> Eco-conscious careers and sustainability
                                    goals.</li>
                                <li><strong>Skill Building:</strong> Training in renewable energy, organic farming, and
                                    green business practices.</li>
                            </ul>

                            <!-- Section 9 -->
                            <h6 class="fw-bold mb-3">9. Student-Led Initiatives</h6>
                            <ul class="mb-4">
                                <li><strong>Innovation Clubs:</strong> Projects in technology and social change.</li>
                                <li><strong>Leadership Opportunities:</strong> Leading community impact projects.</li>
                            </ul>

                            <!-- Section 10 -->
                            <h6 class="fw-bold mb-3">10. Career Guidance & Counseling</h6>
                            <ul class="mb-4">
                                <li><strong>Exploration Workshops:</strong> Career path awareness sessions.</li>
                                <li><strong>Skill-Career Mapping:</strong> Aligning interests and strengths with
                                    professions.</li>
                                <li><strong>Mentorship Programs:</strong> Connecting students with professionals and
                                    alumni.</li>
                            </ul>
                            ...
                            <div class="siderbar">
                                ...
                                <div class="sidebar-block mb-48">
                                    ...
                                    <div class="recent-article mb-12">
                                        <img src="assets/media/blogs/recent-blog-1.jpg" class="article-img" alt="">
                                        <div>
                                    ...
                                    <div class="recent-article mb-12">
                                        <img src="assets/media/blogs/recent-blog-2.jpg" class="article-img" alt="">
                                        <div>
                                            <a href="#" class="fw-500 black mb-8 hover-content">How roofing can pay off
                                                itself in
                                                heating bills</a>
                ...
                <div class="container-fluid">
                    <div class="newslatter-wrapper">
                        ...
                        <div class="mb-5 text-center">
                            ...
                            <p class="mb-0 text-white w-100 text-center mx-auto">Join us on a journey of learning,
                                growth, and
                        ...
                        <div class="row row-gap-4">
                            <div class="col-lg-6">
                                <div class="d-flex gap-16 mt-2 mb-2">
                                    <h2 class="fw-bold mb-3 text-white text-center fs-1">Join <span
                                            class="text-primary">Us</span></h2>
                                    <a href="#"><button class="cus-btn bg-white"><span class="text light-black">Donate
                                                Now</span></button></a>
                                </div>

                                <p class="lead text-white">We invite partnerships with government bodies, corporate
                                    entities, and
                                    development
                                    organizations to expand our reach and deliver impactful programs across the nation.
                                </p>
                                <p class="fw-bold text-white">Together, let us create a skilled, empowered, and
                                    sustainable India.</p>
                            </div>
                            <div class="col-lg-6">
