                                ...
                                @foreach ($upcomingProjects as $project)
                                    <div class="swiper-slide">
                                        <div class="blog-card">
                                            ...
                                            <a href="{{ route('web.upcoming.project', [$project->category->slug, $project->slug]) }}"
                                                class="card-img">
                                                <img src="{{ asset($project->image) }}" alt="{{ $project->title }}">
                                                <span class="date-block">
                                                    <span
        ...
        <div class="row ">
            ...
            <div class="col-md-8">
                ...
                <div class="d-none d-md-none d-lg-none">
                    <div class="background-bubbles"> <span style="left: 10%; animation-delay: 0s;"></span> <span
                            style="left: 30%; animation-delay: 2s;"></span> <span
                            style="left: 50%; animation-delay: 4s;"></span> <span
                            style="left: 70%; animation-delay: 1s;"></span> <span
                            style="left: 90%; animation-delay: 3s;"></span> </div>
