...
<body>
    <div class="maintenance">
        <div class="maintenance_contain">
            ...
            <span class="pp-infobox-title-prefix">COMING SOON</span>

            <div class="pp-infobox-title-wrapper">
                <h3 class="pp-infobox-title">Our website is under maintenance</h3>
            </div>

            <div class="pp-infobox-description">
                <p>We’re performing some scheduled updates to improve your experience.<br>
                    The site will be back online shortly. Thank you for your patience!</p>
            </div>
