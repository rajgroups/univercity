...
@section('content')
    ...
    <section class="title-banner mb-80" style="background-image: url({{ asset($announcement->banner_image) }})">
        <div class="container-fluid">
            <h2 class="fw-500 mb-24">{{ $announcement->title ?? null }}<br class="d-sm-block d-none">
                <span class="color-primary">{{ $announcement->subtitle ?? null }}</span>
            </h2>
