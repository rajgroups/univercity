...
@section('content')
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-4 mb-4">
                <nav id="navbar-example" class="navbar sticky-top flex-column align-items-stretch p-3 bg-light rounded">
                    ...
                    <nav class="nav nav-pills flex-column">
                        ...
                        <a class="nav-link" href="#key-areas">Key Areas of Collaboration</a>
                        <div class="nested-nav nav flex-column ms-3">
                            <a class="nav-link" href="#skill-india">1. Skill India Mission Support</a>
                            <a class="nav-link" href="#vocational">2. Vocational Training in Schools</a>
                            <a class="nav-link" href="#rural">3. Rural Empowerment Programs</a>
                            <a class="nav-link" href="#infrastructure">4. Public Infrastructure Utilization</a>
                            <a class="nav-link" href="#digital">5. Digital Literacy Initiatives</a>
                            <a class="nav-link" href="#employment">6. Employment Linkage Programs</a>
                            <a class="nav-link" href="#women">7. Women’s Empowerment and SHG Support</a>
                            <a class="nav-link" href="#agri">8. Agri and Farmer Development</a>
                            <a class="nav-link" href="#healthcare">9. Healthcare Skill Development</a>
                            <a class="nav-link" href="#energy">10. Renewable Energy and Green Jobs</a>
                        </div>
                        <a class="nav-link" href="#benefits">Benefits</a>
                        <a class="nav-link" href="#cta">Call to Action</a>
                    </nav>
                </nav>
            </div>
            ...
            <div class="col-lg-8">
                <section id="intro">
                    <h3 class="fw-bold mb-4">ISICO Collaboration: Government Collaborations</h3>
                    <p>ISICO recognizes the pivotal role of government partnerships in advancing skill development and
                        education initiatives at a national and regional level. Through Government Collaborations, we aim to
                        align with existing policies and programs, foster sustainable growth, and enhance the socio-economic
                        well-being of rural and underserved communities.</p>
                </section>

                <section id="objectives">
                    <h4 class="fw-bold mt-4">Objectives of Government Collaborations</h4>
                    <ul>
                        <li><strong>Policy Alignment:</strong> Align with NEP 2020, Skill India, and Digital India.</li>
                        <li><strong>Infrastructure Utilization:</strong> Use schools, halls, centers for training.</li>
                        <li><strong>Community Development:</strong> Address rural skill and education needs.</li>
                    </ul>
                </section>

                <section id="key-areas">
                    <h4 class="fw-bold mt-4">Key Areas of Collaboration</h4>
                    <section id="skill-india">
                        <h5>1. Skill India Mission Support</h5>
                        <ul>
                            <li>Sector-specific training in key industries.</li>
                            <li>Partnering with agencies for relevant course design.</li>
                        </ul>
                    </section>

                    <section id="vocational">
                        <h5>2. Vocational Training in Schools</h5>
                        <ul>
                            <li>Integrate vocational courses in curricula.</li>
                            <li>Establish labs in government schools.</li>
                        </ul>
                    </section>

                    <section id="rural">
                        <h5>3. Rural Empowerment Programs</h5>
                        <ul>
                            <li>Livelihood improvement with ministries.</li>
                            <li>Promote entrepreneurship and self-reliance.</li>
                        </ul>
                    </section>

                    <section id="infrastructure">
                        <h5>4. Public Infrastructure Utilization</h5>
                        <ul>
                            <li>Use public spaces for workshops.</li>
                            <li>Modernize spaces for better learning.</li>
                        </ul>
                    </section>

                    <section id="digital">
                        <h5>5. Digital Literacy Initiatives</h5>
                        <ul>
                            <li>Support Digital India by enabling access.</li>
                            <li>Train in basic digital tools and skills.</li>
                        </ul>
                    </section>

                    <section id="employment">
                        <h5>6. Employment Linkage Programs</h5>
                        <ul>
                            <li>Partner with employment exchanges for placements.</li>
                            <li>Align with job schemes for effective hiring.</li>
                        </ul>
                    </section>

                    <section id="women">
                        <h5>7. Women’s Empowerment and SHG Support</h5>
                        <ul>
                            <li>Entrepreneurship and financial training for SHGs.</li>
                            <li>Encourage women in tech and green sectors.</li>
                        </ul>
                    </section>

                    <section id="agri">
                        <h5>8. Agri and Farmer Development</h5>
                        <ul>
                            <li>Modern sustainable farming practices.</li>
                            <li>Support FPOs with training and capacity building.</li>
                        </ul>
                    </section>

                    <section id="healthcare">
                        <h5>9. Healthcare Skill Development</h5>
                        <ul>
                            <li>Train in health care and elder support.</li>
                            <li>Promote telemedicine and digital health.</li>
                        </ul>
                    </section>

                    <section id="energy">
                        <h5>10. Renewable Energy and Green Jobs</h5>
                        <ul>
                            <li>Training in solar, wind, and sustainability sectors.</li>
                            <li>Support green job creation with policy integration.</li>
                        </ul>
                    </section>
                </section>

                <section id="benefits">
                    <h4 class="fw-bold mt-4">Benefits of Government Collaborations</h4>
                    <ul>
                        <li>Wider reach to remote communities.</li>
                        <li>Alignment with national development goals.</li>
                        <li>Shared infrastructure and enhanced learning environments.</li>
                        <li>Improved program outcomes via joint accountability.</li>
                    </ul>
                </section>

                <section id="cta">
                    <h4 class="fw-bold mt-4">Call to Action</h4>
                    <p>ISICO is committed to impactful government partnerships to uplift communities and build a skilled,
                        sustainable workforce across India. Let’s collaborate for a better tomorrow.</p>
                </section>
            </div>
        </div>
    </div>
