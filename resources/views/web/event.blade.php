    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-4 mb-4">
                <div id="sectionNav" class="nav flex-column nav-pills sticky-nav">
                    <a class="nav-link" href="#s1">1. Entrepreneurship Training</a>
                    <a class="nav-link" href="#s2">2. Vocational Skill Training</a>
                    <a class="nav-link" href="#s3">3. Financial Literacy</a>
                    <a class="nav-link" href="#s4">4. Access to Markets</a>
                    <a class="nav-link" href="#s5">5. Health and Wellbeing</a>
                    <a class="nav-link" href="#s6">6. Leadership</a>
                    <a class="nav-link" href="#s7">7. Sustainability</a>
                    <a class="nav-link" href="#s8">8. Community Building</a>
                    <a class="nav-link" href="#s9">9. Legal Support</a>
                </div>
            </div>
            <div class="col-md-8">
                <h3 class="section-title">ISICO Women’s Self-Help Group Skill Development Initiative</h3>
                <p>ISICO is committed to empowering women through skill development, and our Women’s Self-Help Group (SHG)
                    Skill Development program is a vital part of this mission. We aim to provide women in rural and
                    underserved communities with the skills and resources necessary to start their own businesses, improve
                    their livelihoods, and contribute to economic growth. By fostering self-reliance, financial
                    independence, and leadership, ISICO helps create sustainable models that support women’s advancement and
                    wellbeing.</p>

                <h4 class="mt-4">Key Areas of Focus:</h4>

                <div id="s1" class="scrollspy-section">
                    <h5 class="mt-4">1. Entrepreneurship Training</h5>
                    <ul>
                        <li><strong>Objective:</strong> Equip women to start and manage businesses with training in
                            marketing, finance, planning, and customer service.</li>
                        <li><strong>Initiatives:</strong> Workshops and mentoring for women in food processing, textiles,
                            handicrafts, etc.</li>
                        <li><strong>CSR Collaboration:</strong> Corporates can fund training, provide mentorship, and seed
                            funding.</li>
                    </ul>
                </div>

                <div id="s2" class="scrollspy-section">
                    <h5 class="mt-4">2. Vocational Skill Training</h5>
                    <ul>
                        <li><strong>Objective:</strong> Teach employable, income-generating skills.</li>
                        <li><strong>Initiatives:</strong> Hands-on training in tailoring, beauty, crafts, agriculture, and
                            healthcare.</li>
                        <li><strong>CSR Collaboration:</strong> Companies can support with trainers, infrastructure, and
                            resources.</li>
                    </ul>
                </div>

                <div id="s3" class="scrollspy-section">
                    <h5 class="mt-4">3. Financial Literacy and Management</h5>
                    <ul>
                        <li><strong>Objective:</strong> Enable women to manage finances and SHG funds responsibly.</li>
                        <li><strong>Initiatives:</strong> Training on budgeting, saving, investing, and accessing loans.
                        </li>
                        <li><strong>CSR Collaboration:</strong> Corporates can sponsor programs and connect with banks for
                            micro-loans.</li>
                    </ul>
                </div>

                <div id="s4" class="scrollspy-section">
                    <h5 class="mt-4">4. Access to Markets and Networking</h5>
                    <ul>
                        <li><strong>Objective:</strong> Expand reach and sales for SHG products.</li>
                        <li><strong>Initiatives:</strong> Organize fairs, exhibitions, and digital marketing platforms.</li>
                        <li><strong>CSR Collaboration:</strong> Sponsor expos, retail connections, or create online stores.
                        </li>
                    </ul>
                </div>

                <div id="s5" class="scrollspy-section">
                    <h5 class="mt-4">5. Health and Wellbeing Support</h5>
                    <ul>
                        <li><strong>Objective:</strong> Improve women’s health and capacity to thrive personally and
                            professionally.</li>
                        <li><strong>Initiatives:</strong> Workshops on hygiene, mental health, nutrition, and reproductive
                            health.</li>
                        <li><strong>CSR Collaboration:</strong> Provide medical camps and wellness resources through
                            partnerships.</li>
                    </ul>
                </div>

                <div id="s6" class="scrollspy-section">
                    <h5 class="mt-4">6. Leadership and Empowerment</h5>
                    <ul>
                        <li><strong>Objective:</strong> Cultivate leadership and public speaking skills.</li>
                        <li><strong>Initiatives:</strong> Conduct training sessions and involve women in community
                            decisions.</li>
                        <li><strong>CSR Collaboration:</strong> Provide mentoring and leadership platforms for women.</li>
                    </ul>
                </div>

                <div id="s7" class="scrollspy-section">
                    <h5 class="mt-4">7. Sustainability Practices for Women Entrepreneurs</h5>
                    <ul>
                        <li><strong>Objective:</strong> Encourage eco-conscious practices and green entrepreneurship.</li>
                        <li><strong>Initiatives:</strong> Promote eco-friendly methods and business models.</li>
                        <li><strong>CSR Collaboration:</strong> Offer materials and connect with environmental experts.</li>
                    </ul>
                </div>

                <div id="s8" class="scrollspy-section">
                    <h5 class="mt-4">8. Networking and Community Building</h5>
                    <ul>
                        <li><strong>Objective:</strong> Strengthen peer-to-peer support and mentorship among SHGs.</li>
                        <li><strong>Initiatives:</strong> Facilitate meetups, forums, and online communities.</li>
                        <li><strong>CSR Collaboration:</strong> Fund networking events and create mentorship platforms.</li>
                    </ul>
                </div>

                <div id="s9" class="scrollspy-section">
                    <h5 class="mt-4">9. Legal Support and Advocacy</h5>
                    <ul>
                        <li><strong>Objective:</strong> Educate women on their legal rights in business and society.</li>
                        <li><strong>Initiatives:</strong> Awareness sessions and legal aid for SHGs.</li>
                        <li><strong>CSR Collaboration:</strong> Partner with law firms for pro bono legal assistance.</li>
                    </ul>
                </div>
            </div>
        </div>
