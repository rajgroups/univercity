...
@section('content')
    ...
    <form action="{{ route('admin.surveys.store') }}" method="POST" id="surveyBatchForm">
        @csrf
        <div class="card mb-4">
        ...
        <div class="card fixed-footer-card">
            <div class="card-body py-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.surveys.index') }}" class="btn btn-light me-2">Cancel</a>
    ...
    <template id="surveyCardTemplate">
        @include('admin.survey.partials.card', ['index' => 'INDEX_PLACEHOLDER', 'survey' => []])
    </template>
    ...
    <script>
        ...
        function reloadForProject(projectId) {
            if (projectId) {
                window.location.href = `{{ route('admin.surveys.create') }}?project_id=${projectId}`;
            }
        }
