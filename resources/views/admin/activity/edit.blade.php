...
@section('content')
    ...
    <form action="{{ route('admin.activity.update', $activity->id) }}" method="POST" enctype="multipart/form-data" class="edit-activity-form">
        @csrf
        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                    name="slug" value="{{ old('slug', $activity->slug) }}" id="activity-slug" readonly style="background-color: #f8f9fa;">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" 
                                    ...
                                    placeholder="Brief description for listings...">{{ old('short_description', $activity->short_description) }}</textarea>
                         ...
                         <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('start_date') is-invalid @enderror"
                                    name="start_date" value="{{ old('start_date', $activity->start_date->format('Y-m-d\TH:i')) }}">
                                @error('start_date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label fw-bold">End Date <span class="text-danger">*</span></label>
                                <input type="datetime-local" class="form-control @error('end_date') is-invalid @enderror" 
                                    name="end_date" value="{{ old('end_date', $activity->end_date->format('Y-m-d\TH:i')) }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="datetime-local" class="form-control @error('registration_deadline') is-invalid @enderror"
                                    name="registration_deadline" value="{{ old('registration_deadline', optional($activity->registration_deadline ?? null)->format('Y-m-d\TH:i')) }}">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                             ...
                             <textarea class="form-control @error('rules') is-invalid @enderror" name="rules" id="rules_editor" rows="3">{{ old('rules', $activity->rules) }}</textarea>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <select name="type" id="activity-type" class="form-select @error('type') is-invalid @enderror">
                                <option value="1" {{ old('type', $activity->type) == '1' ? 'selected' : '' }}>Event</option>
                                <option value="2" {{ old('type', $activity->type) == '2' ? 'selected' : '' }}>Competition</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="organizer_id" class="form-select @error('organizer_id') is-invalid @enderror">
                                ...
                                @foreach ($organizers as $organizer)
                                    <option value="{{ $organizer->id }}" {{ old('organizer_id', $activity->organizer_id) == $organizer->id ? 'selected' : '' }}>{{ $organizer->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                 ...
                                 <input type="number" class="form-control @error('max_participants') is-invalid @enderror"
                                    name="max_participants" value="{{ old('max_participants', $activity->max_participants) }}" placeholder="Unlimited">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('entry_fee') is-invalid @enderror"
                                        name="entry_fee" value="{{ old('entry_fee', $activity->entry_fee ?? 0) }}">
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            @error('thumbnail_image') <div class="invalid-feedback">{{ $message }}</div> @enderror
                             @if ($activity->thumbnail_image)
                                <div class="p-2 border rounded bg-light text-center position-relative">
                                    <img src="{{ asset($activity->thumbnail_image) }}" class="img-fluid rounded" style="max-height: 150px;">
                                    <div class="form-check mt-2 d-flex justify-content-center">
                                        <input class="form-check-input me-2" type="checkbox" name="remove_thumbnail_image" value="1" id="remove_thumbnail_image">
                                        <label class="form-check-label text-danger small" for="remove_thumbnail_image">Remove</label>
                                    </div>
                                </div>
                            @endif
                        </div>
                        <div class="mb-3">
                            ...
                            @if ($activity->banner_image)
                                <div class="p-2 border rounded bg-light text-center">
                                    <img src="{{ asset($activity->banner_image) }}" class="img-fluid rounded" style="max-height: 150px;">
                                    <div class="form-check mt-2 d-flex justify-content-center">
                                         <input class="form-check-input me-2" type="checkbox" name="remove_banner_image" value="1" id="remove_banner_image">
                                        <label class="form-check-label text-danger small" for="remove_banner_image">Remove</label>
                                    </div>
                                </div>
                            @endif
                        </div>
                                    ...
                                    @foreach($activity->images as $image)
                                        <div class="col-4">
                                            <div class="position-relative border rounded p-1">
                                                <img src="{{ asset($image->file_name) }}" class="img-fluid rounded w-100" style="height: 60px; object-fit: cover;">
                                                <div class="form-check position-absolute top-0 end-0 m-1 bg-white rounded-circle p-1 shadow-sm" style="line-height:0;">
                                                    <input class="form-check-input m-0" type="checkbox" name="remove_gallery_images[]" value="{{ $image->id }}" id="remove_img_{{ $image->id }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <div class="sponsor-item border rounded p-3 mb-3 bg-white shadow-sm position-relative">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-2 text-center">
                         ...
                         <div class="existing-logo-container mt-1 d-none">
                            <img src="" class="img-thumbnail existing-logo-img" width="40">
        ...
        <div class="d-flex justify-content-end mb-5">
            ...
            <button type="submit" class="btn btn-primary btn-lg px-5">
                <i class="feather feather-save me-2"></i>Update Activity
            </button>
        </div>
