                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action-table-data">
                            <div class="d-flex">
                                <a href="{{ route('admin.volunteer.show', $volunteer->id) }}" class="btn p-2 me-1" data-bs-toggle="tooltip" title="View">
                                    <i data-feather="eye" class="feather-eye"></i>
                                </a>
                                {{-- <a href="{{ route('admin.student.edit', $student->id) }}" class="btn p-2 me-1" data-bs-toggle="tooltip" title="Edit">
                                    <i data-feather="edit" class="feather-edit"></i>
                                </a> --}}
                                <form action="{{ route('admin.volunteer.destroy', $volunteer->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
