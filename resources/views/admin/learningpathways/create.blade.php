        ...
        <div class="col-xl-12 col-xxl-12">
            ...
            <div class="card learning-pathway-card">
                <div class="card-header learning-pathway-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    <div>
                        <h4 class="mb-1">
                            <i class="bi bi-rocket-takeoff text-primary me-2"></i>Create Learning Pathway
                        </h4>
                        <p class="mb-0">Design a comprehensive step-by-step educational journey</p>
                    </div>
                ...
                <div class="card-body p-0">
                    <form action="{{ route('admin.learningpathways.store', $project->id) }}" method="POST" id="learningPathwayForm" novalidate>
                        @csrf
                                            ...
                                            <div class="card-body">
                                                <div class="mb-0">
                                                    ...
                                                    <select class="form-select form-select-lg" id="primary_sector_id" name="primary_sector_id" required>
                                                        <option value="" selected disabled>Choose the main sector for this pathway...</option>
                                        ...
                                        <div class="pathway-panel">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="table-responsive border rounded-3 bg-light">
                                                    ...
                                                    <div id="no-sectors-msg" class="text-center py-4 text-muted">
                                        ...
                                        <div class="pathway-panel">
                                            <div class="card-header bg-white d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                                                ...
                                                <div class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25 rounded-pill px-4 py-2 fs-6">
                                                    Selected: <span id="selected-count" class="fw-bold">0</span>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="outcomes" role="tabpanel">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="alert alert-success border-0 shadow-sm d-flex align-items-start gap-3 p-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0 text-dark opacity-75">You have completed all the necessary steps. Review your inputs and click submit to create the pathway.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="step-action-bar d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success btn-submit px-5" id="submit-btn">
                                        <i class="bi bi-send-fill me-2"></i> Create Pathway
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        function renderCourses(courses) {
            ...
            courses.forEach(course => {
                ...
                $card.find('.course-featured-check').on('change', function() {
                    updateSelectedCount(); // Trigger update for hidden inputs
                });
        ...
        function updateSelectedCount() {
            ...
            if (container.length === 0) {
                 container = $('<div id="selected-courses-inputs"></div>').appendTo('#learningPathwayForm');
            }
            container.empty();
