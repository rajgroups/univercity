                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="position" value="{{ old('position', $sector->position) }}"
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="form-select form-select-lg @error('type') is-invalid @enderror">
                                        ...
                                        <option value="1" {{ old('type', $sector->type) == 1 ? 'selected' : '' }}>Normal</option>
                                        <option value="2" {{ old('type', $sector->type) == 2 ? 'selected' : '' }}>INTL</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    @enderror
                                    @if($sector->image)
                                        <div class="mt-3 p-2 border rounded" style="width: fit-content;">
                                            <img src="{{ asset($sector->image) }}" class="img-fluid rounded" style="max-height: 100px;" alt="Current Image">
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary px-4">Update Sector</button>
                        </div>
                    </div>
                </div>
    </form>
