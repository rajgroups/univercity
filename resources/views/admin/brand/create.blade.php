...
@section('content')
    ...
    <form action="{{ route('admin.brand.store') }}" method="POST" class="add-product-form" enctype="multipart/form-data">
        @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{ old('name') }}" placeholder="Enter brand name" required>
                                        @error('name')
