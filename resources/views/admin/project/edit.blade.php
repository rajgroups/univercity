                        ...
                        <div class="accordion-body border-top">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        @if($project->image)
                                            <small class="d-block mt-2">Current: <img src="{{ asset('/storage/' . $project->image) }}" width="80"></small>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        @if($project->banner_image)
                                            <small class="d-block mt-2">Current: <img src="{{ asset('/storage/' . $project->banner_image) }}" width="80"></small>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="type" class="form-select">
                                            <option value="On Going" {{ old('type', $project->type) == 'On Going' ? 'selected' : '' }}>On Going</option>
                                            <option value="Up Coming" {{ old('type', $project->type) == 'Up Coming' ? 'selected' : '' }}>Up Coming</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="summer-description-box">
                                    ...
                                    <textarea name="description" id="summernote" class="form-control" rows="6">{{ old('description', $project->description) }}</textarea>
