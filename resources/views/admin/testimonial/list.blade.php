...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{ route('admin.testimonial.create') }}" class="btn btn-primary"><i class="ti ti-circle-plus me-1"></i>Add
                Testimonial</a>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        <a class="me-2 p-2" href="{{ route('admin.testimonial.edit', $testimonial->id) }}">
