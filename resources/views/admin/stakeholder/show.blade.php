        ...
        <div class="col-lg-4 col-md-12 mb-4">
            <div class="card h-100">
                <div class="card-body text-center mt-3">
                    ...
                    <h4 class="mb-1">{{ $stakeholder->full_name }}</h4>
                    ...
                    <ul class="list-group list-group-flush text-start">
                        <li class="list-group-item px-0">
                            <strong><i class="feather feather-mail me-2 text-muted"></i>Email</strong><br>
                            <a href="mailto:{{ $stakeholder->email }}">{{ $stakeholder->email }}</a>
                        </li>
                        <li class="list-group-item px-0">
                            <strong><i class="feather feather-phone me-2 text-muted"></i>Phone</strong><br>
                            {{ $stakeholder->phone ?? 'N/A' }}
                            @if($stakeholder->alternate_phone)
                                <br><small class="text-muted">Alt: {{ $stakeholder->alternate_phone }}</small>
                            @endif
                        </li>
                    </ul>
                    ...
                    @if($stakeholder->linkedin_url || $stakeholder->twitter_url || $stakeholder->website_url)
                        <div class="mt-4 pt-3 border-top d-flex justify-content-center gap-3">
                            @if($stakeholder->linkedin_url)
                                <a href="{{ $stakeholder->linkedin_url }}" target="_blank" class="text-primary fs-4"><i class="feather feather-linkedin"></i></a>
                            @endif
                            @if($stakeholder->twitter_url)
                                <a href="{{ $stakeholder->twitter_url }}" target="_blank" class="text-info fs-4"><i class="feather feather-twitter"></i></a>
                            @endif
                            @if($stakeholder->website_url)
                                <a href="{{ $stakeholder->website_url }}" target="_blank" class="text-dark fs-4"><i class="feather feather-globe"></i></a>
                            @endif
                        </div>
                    @endif
                </div>
                        ...
                        <div class="tab-pane show active" id="basic-info" role="tabpanel">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8 fw-semibold mb-3">
                                    ...
                                    <small>{{ $stakeholder->engagement_level }} / 5</small>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="professional" role="tabpanel">
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="fs-6">{{ $stakeholder->industry ?? 'N/A' }}</div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6 class="text-muted mb-2">Expertise Area</h6>
                                    <div class="fs-6">{{ $stakeholder->expertise_area ?? 'N/A' }}</div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6 class="text-muted mb-2">Preferred Language</h6>
                                    <div class="fs-6">{{ strtoupper($stakeholder->preferred_language) }}</div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6 class="text-muted mb-2">Influence Level</h6>
                                    <div class="fs-6">{{ $stakeholder->influence_level }} / 4</div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6 class="text-muted mb-2">Interest Level</h6>
                                    <div class="fs-6">{{ $stakeholder->interest_level }} / 3</div>
                                </div>
                            </div>
                        </div>
