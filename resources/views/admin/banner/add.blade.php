    ...
    <form action="add-product.html" class="add-product-form">
        <div class="add-product">
            <div class="accordions-items-seperate" id="accordionSpacingExample">
                ...
                <!-- Add More Button -->
                    <button type="button" class="btn btn-success mt-3" id="addProjectBtn">+ Add Banners</button>
            </div>
        </div>
        <div class="col-lg-12">
...
<script>
    $(document).ready(function () {
        ...
        $('#addProjectBtn').on('click', function () {
            // Clone the first .project-group
            let $clone = $('.project-group:first').clone();
            // Append and then reinitialize Summernote
        ...
        $(document).on('click', '.remove-project', function () {
            if ($('.project-group').length > 1) {
                ...
                alert("At least one project block is required.");
            }
        });
    });
</script>
