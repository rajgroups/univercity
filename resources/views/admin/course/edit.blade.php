                             ...
                             <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="industry_experience_unit" class="form-select">
                                        <option value="days" {{ old('industry_experience_unit', $course->industry_experience_unit) == 'days' ? 'selected' : '' }}>Days</option>
                                        <option value="weeks" {{ old('industry_experience_unit', $course->industry_experience_unit) == 'weeks' ? 'selected' : '' }}>Weeks</option>
                                        <option value="months" {{ old('industry_experience_unit', $course->industry_experience_unit) == 'months' ? 'selected' : '' }}>Months</option>
                                        <option value="years" {{ old('industry_experience_unit', $course->industry_experience_unit ?? 'years') == 'years' ? 'selected' : '' }}>Years</option>
                                    </select>
                                </div>
